...
class TestExplanationParser:
    ...
    def test_batch_parsing(self):
        ...
        texts = ["Migros yanı", "Hotel karşısı", "invalid nonsense text xyz"]
...
class TestEdgeCases:
    ...
    def test_mixed_case_input(self):
        ...
        test_cases = ["MİGROS YANI", "migros yanı", "MiGrOs YaNı"]
...
class TestConfiguration:
    ...
    def test_custom_config(self):
        ...
        config = ExplanationConfig(min_confidence_threshold=0.8, debug_mode=True)
