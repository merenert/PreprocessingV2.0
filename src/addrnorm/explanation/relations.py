...
class SpatialRelationExtractor:
    ...
    def extract_relations(self, text: str) -> List[SpatialRelation]:
        ...
        for relation_type, pattern in self.relation_patterns.items():
            ...
            for match in matches:
                ...
                confidence = self._adjust_confidence(text_lower, match, relation_type, confidence)
    ...
    def _adjust_confidence(self, text: str, match: re.Match, relation_type: str, base_confidence: float) -> float:
        """
        ...
        primary_keywords = self.spatial_keywords[relation_type][:2]  # First 2 are primary
        ...
        landmark_indicators = ['hotel', 'market', 'hastane', 'okul', 'cami', 'park', 'banka']
