...
class LandmarkDetector:
    ...
    def _detect_category_landmarks(
    ...
    def _detect_business_landmarks(
        self, original_text: str, text_lower: str
    ) -> List[Landmark]:
    ...
    def _extract_landmark_name(
        self, original_text: str, text_lower: str, match: re.Match, category: str
    ) -> Optional[Landmark]:
    ...
    def _extract_business_name(
        self, original_text: str, text_lower: str, match: re.Match, suffix_type: str
    ) -> Optional[Landmark]:
    ...
    def _reconstruct_original_case(
        self, original_text: str, lowercase_text: str
    ) -> str:
    ...
    def _calculate_landmark_confidence(
        self, name: str, category: str, match_type: str
    ) -> float:
