...
class PatternReviewInterface:
    ...
    def _serialize_suggestion(self, suggestion: PatternSuggestion) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": f"ML-generated pattern from {suggestion.pattern_type.value}",
            "confidence_score": suggestion.confidence,
            "expected_fields": [],  # Not available in new model
            "sample_matches": suggestion.examples,
            "quality_metrics": {},  # Not available in new model
